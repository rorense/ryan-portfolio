...
export function Experience() {
  ...
  return (
    <section id="experience" className="px-6 py-20">
      ...
      >
        <p className="text-sm uppercase tracking-[0.18em] text-sky-600">Experience</p>
        <h2 className="mt-4 text-3xl font-semibold text-slate-900">Career timeline</h2>
        <div className="mt-10 border-l border-sky-200 pl-6">
